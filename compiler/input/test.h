...
//typedef std::vector<Centroid_new> CentroidVec_t;
__Fluid__
typedef struct { ////
	float r;
	float g;
...
//typedef std::vector<RgbPixel_new> RgbPixelVec_t;
...
public:
	...
	virtual void AssignCluster(RgbImage_new* image, Clusters_new* clusters); //
